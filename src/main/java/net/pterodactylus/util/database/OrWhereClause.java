/*
 * utils - OrWhereClause.java - Copyright © 2012–2016 David Roden
 *
...
/**
 * {@link WhereClause} implementation that performs an OR conjunction of an
...
public class OrWhereClause implements WhereClause {
	 ...
	 */
	public OrWhereClause(WhereClause... whereClauses) {
	 ...
	 *            The where clauses to connect
	 */
	public OrWhereClause(Collection<WhereClause> whereClauses) {
	 ...
	 */
	public OrWhereClause add(WhereClause whereClause) {
